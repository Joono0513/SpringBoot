...
public class SecurityConfig {
     ...
     * 
     * ✅ 인가(Authorization)
     * : 사용자의 권한을 확인하여 권한에 따라 자원 사용 범위를 구분하여 허락
     */
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.formLogin(login -> login
                    .defaultSuccessUrl("/")
                    .loginPage("/login")    // GET
                    .loginProcessingUrl("/loginPro")   // POST
        ...
        // tokenRepository()        : 토큰을 저장할 저장소 지정 (데이터 소스 포함한 저장소 객체)
        //                          🎁 persistent_logins (자동 로그인 테이블)
        // tokenValiditySeconds()   : 토큰 유효 시간 설정 (예시 : 7일)
